...
const PlaceOrder = () => {
  ...
  const { getTotalCartAmount, token, food, cartItems,setCartItems, url } = useContext(StoreContext);
      ...
      <div className="place-order-right">
        ...
        <div className="order-summary">
          <div className="order-item">
            <span>Subtotal:</span> <span>₹{getTotalCartAmount()}</span>
          </div>
          <div className="order-item">
            <span>Delivery Fee:</span>
            <span>₹{getTotalCartAmount() === 0 ? 0 : getTotalCartAmount() > 200 ? 0 : 40}</span>
          </div>
